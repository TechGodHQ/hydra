...
pub fn generated_router() -> Router<crate::UnusedState> {
    Router::new()
...
pub fn bind_subscribe_events(router: Router<crate::UnusedState>) -> Router<crate::UnusedState> {
    super::bind_runtime_sse_subscribe_events(router)
}

async fn list_messages(
    State(state): State<crate::UnusedState>,
    Path(path): Path<BTreeMap<String, String>>,
    Query(query): Query<BTreeMap<String, String>>,
) -> Response {
    crate::unused_dispatch(
        &state,
        "list_messages",
